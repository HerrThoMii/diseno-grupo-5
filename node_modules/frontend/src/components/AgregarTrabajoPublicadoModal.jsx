...
const AgregarTrabajoPublicadoModal = ({ isOpen, onClose, onAdd }) => {
  ...
  return (
    <div className="atpm-overlay" onClick={handleClose}>
      <div className="atpm-modal" onClick={(e) => e.stopPropagation()}>
        <div className="atpm-header">
          <h2>Agregar Trabajo Publicado</h2>
          <button className="atpm-close" onClick={handleClose}>
            <X size={24} />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="atpm-form">
          <div className="atpm-form-group">
            ...
            />
            {errors.nombre && <span className="atpm-error">{errors.nombre}</span>}
          </div>
          ...
          <div className="atpm-form-group">
            ...
            />
            {errors.titulo && <span className="atpm-error">{errors.titulo}</span>}
          </div>
          ...
          <div className="atpm-form-group">
            ...
            />
            {errors.issn && <span className="atpm-error">{errors.issn}</span>}
          </div>
          ...
          <div className="atpm-form-group">
            ...
            />
            {errors.editorial && <span className="atpm-error">{errors.editorial}</span>}
          </div>
          ...
          <div className="atpm-form-group">
            ...
            />
            {errors.pais && <span className="atpm-error">{errors.pais}</span>}
          </div>

          <div className="atpm-buttons">
            <button type="button" className="atpm-btn-cancel" onClick={handleClose}>
              Cancelar
            </button>
            <button type="submit" className="atpm-btn-submit">
              Agregar Trabajo Publicado
            </button>
          </div>
        </form>
      </div>
...
export default AgregarTrabajoPublicadoModal;
